...
- All new tools support selection, movement, duplication, undo/redo, and flattened exports.

## 0.1.0

Initial screenshot-first Chrome release: visible/area capture, dedicated editor,
